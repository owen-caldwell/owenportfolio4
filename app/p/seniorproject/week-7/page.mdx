...
![White dots on a black screen with a red bounding box](/seniorproject/bounding-box.png)
...
![A text file containing a seemingly random string of F, G, +, and - characters.](/seniorproject/lsystem-info.png)
